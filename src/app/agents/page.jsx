...
import vehicle_store from "../../../public/images/png/vehicle_store.png";
        ...
        <div className="px-5 lg:p-10">
          <div className="bg-[#0B0B40] rounded-2xl md:px-5 2xl:px-[28px] pb-7 pt-[23px]">
            <div className="lg:flex items-center justify-between">
              <Image
                className="lg:h-[200px] lg:w-[200px] h-[150px] w-[150px] mx-auto lg:mx-0 "
                src={vehicle_store}
              />
              ...
              <div className="ms-[27px]">
                  ...
                  <div className="md:flex md:justify-between  w-full mt-[20px] 2xl:mt-0">
                    <div className="flex justify-between w-full xl:me-[60px] lg:me-[30px] me-[20px] overflow-y-scroll scroll_hide">
                      <p className=" 2xl:text-[20px] whitespace-nowrap sm:text-[16px] text-[12px] leading-[150%] ff_gothamMedium  font-normal text-[#F800C0] me-[15px] ">
                        Active Listing{" "}
                        <span className="text-[white] 2xl:text-[24px] sm:text-[18px] text-[12px] ff_gothamMedium">
                          {" "}
                          / 5
                        </span>
                      </p>
                ...
                <p className="text-[white] font-light xl:text-[20px] md:text-[18px] sm:text-[16px] text-[14px] xl:leading-[150%]  mt-[10px] opacity-70 ff_got hamMedium ">
                  ...
                  cursus, quam risus imperdiet ipsum, ac suscipit urna justo at
                  est. Donec nisl purus, aliquet ut placerat non, tincidunt eu
                  leo. Donec velit est, tempor nec lectus sed, sagittis
                  hendrerit orci. Phasellus sit amet tempus velit. Phasellus ac
                  urna at augue vehicula posuere ac id ex. Pellentesque varius
                  vulputate elit, et tempus ligula tincidunt id. Proin tempus
                  congue imperdiet. Mauris ut euismod purus. Mauris egestas
                  vulputate ante sed imperdiet. In placerat euismod justo.
                </p>
              </div>
            </div>
            ...
            <div className="z-10 relative flex flex-wrap justify-center mt-[51px] px-5 lg:px-10 ">
              ...
              <div className="w-full xl:w-7/12 md:px-3 mt-12 xl:mt-0">
                <div className="sm:flex items-center justify-center overflow-auto">
                  <div className="sm:mt-0 mt-[20px] border-[1px] border-gradient-to-r from-[#7670FF] to-[#5B42FF] rounded-[90px] shadow-[0px_0px_8px_0px_#4B4CFF] flex justify-between me-[10px] ">
                    {["FeaturedMotorListing", "MotorListing", "Agents"].map(
                      (name) => (
                        <span key={name}>
                          <button
                            className={`font-normal 2xl:text-[20px] text-[16px] leading-[150%] text-white py-[9px] px-[34px] cursor-pointer rounded-[90px] hover:bg-gradient-to-r hover:from-[#7670FF] hover:to-[#5B42FF] hover:shadow-[0px_0px_8px_0px_#4B4CFF] ${
                              activeCategory === name
