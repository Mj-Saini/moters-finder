...
const page = () => {
  ...
  return (
    <div className=" min-h-[calc(100vh-106px)] px-5">
      <div className="flex flex-wrap">
        <div className="card_bg_gradient  w-1/2 p-6  rounded-3xl card_shadow">
          ...
          <p className="text-[20px] font-[300] leading-[150%] text-white">
            ...
            km/day (AED 3 per additional km applicable). Security deposit of AED
            2000 is required. Contact Speedy Machine Car Rental directly for
          ...
          <div>
            ...
            <p className=" text-[24px] font-[350] leading-[150%]">
              Simon Quitzon
            </p>
          </div>
        </div>
